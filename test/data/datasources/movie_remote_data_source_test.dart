...
import 'package:kutal_stream_app/core/errors/server_exception.dart';
...
void main() {
  ...
  const tUrl =
      'https://api.themoviedb.org/3/trending/movie/day?api_key=c3e653dff4bd93a2b4ae4b3a6d8c1912';
  const pUrl =
      'https://api.themoviedb.org/3/movie/popular?api_key=c3e653dff4bd93a2b4ae4b3a6d8c1912';
  const sUrl =
      'https://api.themoviedb.org/3/search/movie?query=$tQuery&api_key=c3e653dff4bd93a2b4ae4b3a6d8c1912';
